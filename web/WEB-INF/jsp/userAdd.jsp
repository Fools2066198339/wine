    ...
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>请输入用户的昵称
            </div>
        </div>
        <div class="layui-form-item">
    ...
    layui.use(['form','layer'], function(){
        ...
        form.on('submit(add)', function(data){
            ...
            $.ajax({
                ...
                data: {"name":nicknameValue, "username":usernameValue,
                       "password":passwordValue, "phone":phoneValue,
                       "email":emailValue, "address":addressValue},
